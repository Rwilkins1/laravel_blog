	...
	<div class = "col-md-12 col-sm-8 text-center">
		...
		<div class = "col-md-4 col-md-offset-4">
			<ul>
				...
				<li><h4>Spatula City (A spatula-based Adlister):</h4><a href="{{{action('HomeController@gotospatulas')}}}" target="_blank"><img id="spatulacity" src="/img/spatulacity.png"></a></li>
