...
require_once '../app/views/spatulacity/utils/Input.php';
...
<!DOCTYPE html>
<html lang="en">
    <?php require_once '../app/views/spatulacity/views/header.php'; ?>

    <body class="meetColor">
        <?php require_once '../app/views/spatulacity/views/navbar.php'; ?>
        ...
        <?php require_once '../app/views/spatulacity/views/footer.php'; ?>
